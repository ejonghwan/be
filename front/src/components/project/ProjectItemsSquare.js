...
const ProjectItemsSquare = ({ project, isContent = false, isTag = false }) => {
    return (
        <Fragment>
            <Link to={`/project/detail/${project._id}`} >
                <div className='info_wrap'>
                    ...
                    <div>
                        <strong className='project_title word_ellip_1'>{project?.title}</strong>
...
export default ProjectItemsSquare;
